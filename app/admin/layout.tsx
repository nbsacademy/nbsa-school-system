          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-amber-400 text-slate-950 text-[9px] font-black px-2 py-0.5 rounded-full hidden sm:inline-block">
                  ADMIN PORTAL
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-2 text-xs font-medium text-blue-200">
          <div>
            ...
            <p className="text-[10px] text-blue-300">
              All Rights Reserved. Admin Management System.
            </p>
          </div>
