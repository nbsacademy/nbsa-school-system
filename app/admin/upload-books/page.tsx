...
export default function UploadBooksPage() {
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto flex items-center justify-center min-h-[70vh] text-left font-sans text-slate-900">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border-t-8 border-blue-900 text-center space-y-6 w-full">
        ...
        <p className="text-gray-500 text-xs md:text-sm max-w-md mx-auto leading-relaxed">
          This feature is currently under development and will be available in the upcoming version update.
        </p>
