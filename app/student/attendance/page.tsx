...
export default function StudentAttendanceGraphPage() {
  ...
  return (
    <div className="p-4 md:p-10 max-w-4xl mx-auto font-sans text-slate-900">
      <div className="bg-white rounded-3xl p-8 sm:p-12 border shadow-sm text-center space-y-6">
        ...
        {/* Animated Icon & Badge */}
        <div className="w-20 h-20 bg-teal-50 text-teal-900 border border-teal-200 rounded-3xl flex items-center justify-center text-4xl mx-auto shadow-inner">
          📊
        </div>

        <div className="space-y-2">
          <span className="bg-teal-100 text-teal-900 text-[11px] font-black px-3.5 py-1 rounded-full uppercase tracking-wider">
            FEATURE UNDER DEVELOPMENT
          </span>
          <h1 className="text-2xl sm:text-3xl font-black text-blue-950 pt-2">
            Attendance & Monthly Analytics Graph
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
            Track your daily class presence, monthly attendance percentages, leave history, and graphical progress reports here.
          </p>
        </div>
        ...
        <div className="bg-slate-50 border border-dashed border-slate-300 p-6 rounded-2xl max-w-sm mx-auto space-y-2">
          ...
          <p className="text-[11px] text-slate-500 font-medium">
            Daily Class Attendance Records & Graphical Analytics
          </p>
        </div>
