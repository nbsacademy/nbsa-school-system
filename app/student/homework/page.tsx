  ...
  return (
    <div className="p-4 md:p-10 max-w-4xl mx-auto font-sans text-slate-900">
      <div className="bg-white rounded-3xl p-8 sm:p-12 border shadow-sm text-center space-y-6">
        ...
        {/* Animated Badge & Icon */}
        <div className="w-20 h-20 bg-amber-50 text-amber-900 border border-amber-200 rounded-3xl flex items-center justify-center text-4xl mx-auto shadow-inner">
          📝
        </div>

        <div className="space-y-2">
          <span className="bg-amber-100 text-amber-900 text-[11px] font-black px-3.5 py-1 rounded-full uppercase tracking-wider">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
            The automated daily homework diary and home assignment submission portal is coming soon for students and parents.
          </p>
        </div>
        ...
        <div className="bg-slate-50 border border-dashed border-slate-300 p-6 rounded-2xl max-w-sm mx-auto space-y-2">
          ...
          <p className="text-[11px] text-slate-500 font-medium">
            Assigned Tasks, Subject Diaries & Home Deadlines
          </p>
        </div>
