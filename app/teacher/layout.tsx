...
export default function TeacherLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans flex flex-col justify-between">
      ...
      {/* TEACHER HEADER */}
      <header className="bg-gradient-to-r from-blue-950 via-slate-900 to-blue-900 text-white shadow-md border-b border-blue-800/50 sticky top-0 z-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-sky-500/20 text-sky-300 border border-sky-500/30 text-[9px] font-black px-2 py-0.5 rounded-full hidden sm:inline-block">
                  FACULTY PORTAL
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-2 text-xs font-medium text-blue-200">
          <div>
            ...
            <p className="text-[10px] text-blue-300">
              All Rights Reserved. Teacher & Faculty Academic Portal.
            </p>
          </div>
